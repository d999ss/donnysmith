      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ color: '#8b949e', marginLeft: '12px' }}>donnysmith@terminal ~ $</span>
          </div>
                  ...
                  {providers.map(provider => (
                    <button
                      ...
                      style={{
                        ...
                        padding: '8px 12px',
                        border: 'none',
                        background: selectedProvider === provider.id ? '#30363d' : 'transparent',
                        color: '#c9d1d9',
                        cursor: 'pointer',
                        fontSize: '12px'
                      }}
        ...
        <div style={{
          ...
          {messages.map((msg, i) => (
            <div key={msg.id || i} style={{ marginBottom: '16px' }}>
              <div style={{ 
                color: msg.role === 'user' ? '#7c3aed' : '#22c55e',
                marginBottom: '4px',
                fontSize: '12px'
              }}>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <span style={{ color: '#7c3aed', fontSize: '12px', flexShrink: 0 }}>
              user@terminal ~ $
            </span>
            <input
              type="text"
